...
const AssignmentForm = () => {
  ...
  if (fetching) {
    return (
      <div className="max-w-5xl mx-auto pb-20 animate-pulse space-y-8">
        ...
        <div className="h-72 bg-white rounded-4xl border border-gray-100" />
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      {/* ── API error banner ── */}
      {apiError && (
        <div className="mb-6 px-5 py-4  shadow-2xl  rounded-2xl text-sm font-bold text-red-600">
          {apiError}
        </div>
      )}

      ...
      <form onSubmit={formik.handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white p-8 rounded-3xl shadow-[0_8px_30px_-12px_rgba(0,0,0,0.04)] border border-gray-100 relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-8">
              <div className="p-3 bg-blue-50 text-[#0054a6] rounded-2xl"><Briefcase className="w-6 h-6" /></div>
              <h2 className="text-2xl font-medium tracking-wider text-gray-700">Position Details</h2>
            </div>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-[0_8px_30px_-12px_rgba(0,0,0,0.04)] border border-gray-100 relative">
            ...
            <div className="flex items-center gap-3 mb-8">
              <div className="p-3 bg-blue-50 text-[#0D80F2] rounded-2xl"><FileText className="w-6 h-6" /></div>
            ...
            <div className="relative">
              <MultiSelectSearch
                ...
                onChange={(vals) => formik.setFieldValue("requiredDocuments", vals)}
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white p-8 rounded-3xl shadow-[0_8px_30px_-12px_rgba(0,0,0,0.04)] border border-gray-100 relative">
            ...
            <div className="flex items-center gap-3 mb-8">
              <div className="p-3 bg-orange-50 text-[#fc7728] rounded-2xl"><ShieldCheck className="w-6 h-6" /></div>
              <h2 className="text-xl font-medium tracking-wider text-gray-700">Mandatory</h2>
            </div>
            ...
            <div className="relative">
              <MultiSelectSearch
                ...
                onChange={(vals) => formik.setFieldValue("mandatoryDocuments", vals)}
            ...
            {(brochureFile || brochurePreview) ? (
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-400 font-medium mt-1">PDF, DOCX, PNG, JPG</p>
                </div>
              </label>
            )}

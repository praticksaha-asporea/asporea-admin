      ...
      <div className="bg-white rounded-xl shadow-2xl   overflow-hidden mb-10">
        <div className="flex justify-between px-6 py-4 bg-gray-50 text-[11px] font-bold text-gray-600 uppercase border-b border-gray-200">
          <div className="flex gap-4 w-full">
            ...
            <span className="w-48">Section Name</span>
            <span className="w-48">Under </span>
            ...
            {sections.map((section, index) => (
              ...
              >
                <div className="flex gap-4 w-full items-center">
                 ...
                 <span className="flex-1 min-w-0 pr-4 text-[14.5px] font-semibold text-gray-700 break-words whitespace-normal leading-tight">
  {section.section}
</span>
                  <span className="w-48 text-[13px] font-medium text-gray-500">
                  
                    {getParentName(section.underSection)}
                  </span>
                  <span className="flex-1 text-[13px] font-medium text-blue-500 bg-blue-50 px-2 py-1 rounded w-fit">
                    {section.shortName}
                  </span>
                </div>
                ...
                <div className="flex gap-10 min-w-50 justify-end items-center">
                  ...
                  <button onClick={() => navigate(`/assessment-sections/edit/${section._id}`)} className="text-gray-400 hover:text-blue-500 transition-colors p-1" title="Edit Section">

import { Save, Settings, Hash, Users, Clock, FileText, Timer } from "lucide-react";
    ...
    <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="max-w-5xl mx-auto pb-20">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 bg-white p-4 rounded-3xl shadow-[0_8px_30px_-12px_rgba(0,0,0,0.04)] border border-gray-50 gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-700 tracking-wider font-mono">General Settings</h1>
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white p-8 rounded-3xl shadow-[0_8px_30px_-12px_rgba(0,0,0,0.04)] border border-gray-100 relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-8">
              <div className="p-3 bg-blue-50 text-[#0054a6] rounded-2xl"><Users className="w-6 h-6" /></div>
              <div>
                <h2 className="text-2xl font-medium tracking-wider text-gray-700">TAC Assignment</h2>
                <p className="text-xs text-gray-400 font-medium mt-1">How inquiries are assigned to TAC officers</p>
              </div>
            </div>
              ...
              {(["random", "counterwise"] as const).map((mode) => {
                ...
                return (
                  <button
                    type="button"
                    key={mode}
                    onClick={() => formik.setFieldValue("tacAssignmentType", mode)}
                  ...
                  >
                    <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${
                      ...
                      {isSelected && <div className="w-2 h-2 rounded-full bg-[#0054a6]" />}
                    </div>
                    <p className={`text-sm font-black capitalize ${isSelected ? "text-[#0054a6]" : "text-gray-600"}`}>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-[0_8px_30px_-12px_rgba(0,0,0,0.04)] border border-gray-100 relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-8">
              <div className="p-3 bg-orange-50 text-[#fc7728] rounded-2xl"><Hash className="w-6 h-6" /></div>
              <div>
                <h2 className="text-2xl font-medium tracking-wider text-gray-700">Inquiry Number Format</h2>
                <p className="text-xs text-gray-400 font-medium mt-1">Pattern used to generate inquiry IDs</p>
              </div>
            </div>

            <div className="space-y-4">
              <div className="space-y-2">
                <label className="text-xs font-bold text-gray-500 uppercase tracking-widest pl-2">Format Pattern</label>
                <div className="relative group">
                  ...
                  <input
                    ...
                    className={`w-full pl-14 pr-4 py-4 bg-gray-50 border-2 rounded-2xl outline-none font-black text-gray-800 tracking-widest transition-all ${
                      formik.touched.inquiryNumberFormat && formik.errors.inquiryNumberFormat
                ...
                {formik.touched.inquiryNumberFormat && formik.errors.inquiryNumberFormat && (
                  <p className="text-red-500 text-xs font-bold pl-2">{formik.errors.inquiryNumberFormat}</p>
                )}
              </div>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white p-8 rounded-3xl shadow-[0_8px_30px_-12px_rgba(0,0,0,0.04)] border border-gray-100 relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-6">
              <div className="p-3 bg-gray-50 text-gray-500 rounded-2xl"><FileText className="w-5 h-5" /></div>
              <h2 className="text-xl font-medium tracking-wider text-gray-700">System Stats</h2>
            </div>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-[0_8px_30px_-12px_rgba(0,0,0,0.04)] border border-gray-100 relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-6">
              <div className="p-3 bg-blue-50 text-[#0054a6] rounded-2xl"><Timer className="w-5 h-5" /></div>
              <div>
                <h2 className="text-xl font-medium tracking-wider text-gray-700">Timelines</h2>
                <p className="text-xs text-gray-400 font-medium mt-0.5">In hours</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              {(
                [
                  ...
                  { field: "preCounsellingTimelineHours", label: "Pre-Counselling" },

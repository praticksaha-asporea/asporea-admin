...
//         <span
//           key={ext}
//           className="text-[10px] font-black text-[#0054a6] bg-blue-50 px-2 py-1 rounded-md uppercase tracking-wider"
//         >
//           .{ext}
//         </span>
//       ))}
...
// const columns: ColumnDef<DocumentTypeResponseData>[] = [
//   {
...
//     header: "Extensions",
//     accessor: (row) => (
//       <ExtensionsCell extensions={row.supportedExtensions ?? []} />
//     ),
//   },
//   {
//     header: "Required",
...
//       const backendData = res?.data as unknown as {
...
//   return (
//     <CustomTable<DocumentTypeResponseData>
...
import { useTypesList, PAGE_SIZE } from "./useTypesList";
import type { DocumentTypeResponseData } from "../../../types/responses/document/documentType.responses";
